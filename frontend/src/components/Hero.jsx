const Hero = () => {
  return (
    <section id="home" className="min-h-screen flex items-center section-padding relative overflow-hidden w-full">
      {/* Background Elements */}
          ...
          <div className="animate-fade-in-up">
            <div className="mb-8">
              <div className="inline-flex items-center space-x-2 bg-white/80 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg border border-purple-100 mb-6">
                ...
                <span className="text-purple-700 font-medium text-sm">Available for freelance work</span>
              </div>
            </div>
            ...
            <div className="mb-8">
              <h2 className="text-2xl sm:text-3xl md:text-4xl text-gray-700 mb-4 font-light">
                ...
                <span className="relative inline-block">
                  <span className="text-purple-600 font-semibold">Developer</span>
                  <svg className="absolute -bottom-1 left-0 w-full h-2" viewBox="0 0 100 8" fill="none">
                    <path d="M0 4C20 1 40 1 60 4C80 7 90 7 100 4" stroke="url(#gradient)" strokeWidth="2" fill="none"/>
                    <defs>
            ...
            <p className="text-lg sm:text-xl text-gray-600 mb-10 leading-relaxed max-w-xl">
              I create <span className="font-semibold text-purple-600">beautiful</span>, 
              <span className="font-semibold text-blue-600"> functional</span>, and 
              <span className="font-semibold text-indigo-600"> user-friendly</span> web applications 
              using cutting-edge technologies. Let's build something amazing together.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-6 mb-12">
              <a href="#projects" className="group relative overflow-hidden bg-gradient-to-r from-purple-600 to-blue-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold text-base sm:text-lg shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
              ...
              <a href="#contact" className="group bg-white text-gray-700 px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold text-base sm:text-lg border-2 border-gray-200 hover:border-purple-300 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center space-x-2">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-8">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-600 font-medium">Open to opportunities</span>
              </div>
              <div className="flex space-x-4">
                <a href="#" className="group bg-white p-3 rounded-full shadow-lg hover:shadow-xl transform hover:scale-110 transition-all duration-300 border border-gray-100 hover:border-purple-200">
                ...
                <a href="#" className="group bg-white p-3 rounded-full shadow-lg hover:shadow-xl transform hover:scale-110 transition-all duration-300 border border-gray-100 hover:border-purple-200">
                  <svg className="w-5 h-5 text-gray-600 group-hover:text-blue-500 transition-colors" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="relative">
              ...
              <div className="relative w-80 h-80 sm:w-96 sm:h-96 mx-auto">
                ...
                <div className="absolute -top-4 left-4 sm:left-8 bg-white p-2 sm:p-3 rounded-full shadow-lg animate-bounce-slow">
                  <svg className="w-4 h-4 sm:w-6 sm:h-6 text-blue-500" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="absolute top-8 -right-2 sm:-right-4 bg-white p-2 sm:p-3 rounded-full shadow-lg animate-bounce-slow animation-delay-1000">
                  <svg className="w-4 h-4 sm:w-6 sm:h-6 text-green-500" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="absolute bottom-4 -left-2 sm:-left-4 bg-white p-2 sm:p-3 rounded-full shadow-lg animate-bounce-slow animation-delay-2000">
                  <svg className="w-4 h-4 sm:w-6 sm:h-6 text-purple-500" fill="currentColor" viewBox="0 0 24 24">
